...
| 02 — Neural Bigrama | Rede neural simples, gradiente, substituindo contagens por pesos | em breve |
| 03 — Markov | Contexto expandido, ordem N, cadeias de Markov | em breve |
| 04 — HMM | Estados ocultos, algoritmo de Viterbi | em breve |
| 04 — Redes Neurais | Perceptron, backpropagation, funções de ativação | em breve |
| 05 — Embeddings | Representação densa, word2vec, espaço vetorial | em breve |
| 06 — Attention | Mecanismo de atenção, contexto dinâmico | em breve |
| 07 — Transformers | Arquitetura completa, self-attention, positional encoding | em breve |
| 08 — LLMs | Pré-treino, fine-tuning, RLHF, scaling laws | em breve |
